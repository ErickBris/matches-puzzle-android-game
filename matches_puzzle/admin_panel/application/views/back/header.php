...
<html lang="en">
    <head>
        ...
        -->
        <meta charset="utf-8">
        <title>Matches Puzzle - Admin Panel</title>
            ...
            <div class="navbar">
                <div class="navbar-inner">
                    <div class="container-fluid">
                        ...
                        <a class="brand" href="<?php echo base_url(); ?>admin"> <img alt="Logo" src="<?php echo base_url(); ?>global/views/back/img/app_icon.png" /> <span>Admin Panel</span></a>
                    ...
                    <div class="span2 main-menu-span">
                        <div class="well nav-collapse sidebar-nav">
                            <ul class="nav nav-tabs nav-stacked main-menu">
                                ...
                                <li id="levels-admin_levels"><a class="ajax-link" href="<?php echo base_url(); ?>levels/admin_levels"><i class="icon-flag"></i><span class="hidden-tablet"> Levels</span></a></li>                                
                            </ul>                            
                        </div><!--/.well -->
                    </div><!--/span-->
                    <!-- left menu ends -->
