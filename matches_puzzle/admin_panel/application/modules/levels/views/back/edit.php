<div>
    <ul class="breadcrumb">
        ...
        <li>
            <?php echo lang("title_edit_level"); ?>
        </li>
    </ul>
</div>
...
<div class="row-fluid sortable">
    <div class="box span12">
        <div class="box-header well" data-original-title>
            <h2><i class="icon-edit"></i> <?php echo lang("title_edit_level"); ?></h2>            
        </div>
        <div class="box-content">  
            ...
            <?php } ?>
            <?php //echo form_open_multipart("levels/admin_levels/edit/" . $level->_leid, array('class' => 'form-horizontal')); ?>
            <form class="form-horizontal">
                <fieldset>
                    <legend><?php echo lang("title_edit_level"); ?> : <?php echo $level->le_number; ?></legend>
                    <div class="control-group">
                        <label class="control-label" for="le_number"><?php echo lang("input_number"); ?></label>
                        <div class="controls">                                                        
                            <input type="text" id="le_number" name="le_number" value="<?php echo set_value("le_number", $level->le_number); ?>" class="input-xlarge focused" readonly="readonly" />
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">                                                        
                            <input type="text" id="le_x_value" name="le_x_value" value="<?php echo set_value("le_x_value", $level->le_x_value); ?>" class="input-xlarge focused" />
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">                            
                            <select id="le_operator" name="le_operator">
                                ...
                                <option value="+" <?php echo set_select('le_operator', "+", ($level->le_operator == "+") ? TRUE : FALSE); ?>>+</option>                                                                             
                                <option value="-" <?php echo set_select('le_operator', "-", ($level->le_operator == "-") ? TRUE : FALSE); ?>>-</option>                                                                             
                            </select>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">                                                        
                            <input type="text" id="le_y_value" name="le_y_value" value="<?php echo set_value("le_y_value", $level->le_y_value); ?>" class="input-xlarge focused" />
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">                                                        
                            <input type="text" id="le_r_value" name="le_r_value" value="<?php echo set_value("le_r_value", $level->le_r_value); ?>" class="input-xlarge focused" />
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">                            
                            <select id="le_moves" name="le_moves">
                                ...
                                <option value="1" <?php echo set_select('le_moves', "1", ($level->le_moves == "1") ? TRUE : FALSE); ?>>1</option>                                                                             
                                <option value="2" <?php echo set_select('le_moves', "2", ($level->le_moves == "2") ? TRUE : FALSE); ?>>2</option>                                                                             
                            </select>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">                                                        
                            <input type="text" id="le_solution" name="le_solution" value="<?php echo set_value("le_solution", $level->le_solution); ?>" class="input-xlarge focused" />
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <label class="checkbox">
                                <input type="checkbox" id="le_status" value="1" name="le_status" <?php echo set_checkbox("le_status", "1", ($level->le_status == 1) ? TRUE : FALSE); ?> />
